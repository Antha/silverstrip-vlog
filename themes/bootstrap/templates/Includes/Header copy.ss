<div class="container">
        <div class="row align-items-stretch">
            ...
            <div class="navbar navbar-expand-lg navbar-light col-5 col-sm-6 col-md-8 d-lg-none py-0">
                <button class="navbar-toggler mx-auto my-1 ml-sm-auto mr-sm-2" type="button"
                ...
                <% if $SearchForm %>
                    <button class="navbar-toggler my-1 mx-auto mx-sm-2" type="button"
                ...
                <% with $SiteConfig.ContactPage %>
                    <% if $PhoneNumber %>
                        <a class="nav-link my-1 mx-auto mx-sm-2" href="tel:$PhoneNumber">
                            <i class="fas fa-phone"></i>
                        </a>
                    <% end_if %>
                    <% if $Email %>
                        <a class="nav-link my-1 mx-auto mx-sm-2" href="mailto:$Email">
