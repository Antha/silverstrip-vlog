...
<section class="features py-5 bg-light">
    <div class="container">
        <h2 class="text-center fw-bold mb-5">In‑Progress Orders</h2>
        <div class="table-responsive">
            <table class="table table-striped table-bordered table-hover align-middle text-center">
                ...
                <tbody>
                <% if $InProgressObjects %>
                        <% loop $InProgressObjects %>
                            <tr>
                                <td>$ID</td>
                                <td class="text-start">
        ...
        Swal.fire({
            ...
            cancelButtonText: 'No'
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = "$Link('changeStatusToPaid')/$CurrentUserID"
                });
